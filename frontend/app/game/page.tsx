...
export default function GamePage() {
  ...
  const addDemoPlayers = () => {
    const demoPlayers = [
      { id: "player1", name: "Player1", skin: "🤖", health: 85, speed: 5, shield: 0, position: { x: 800, y: 900 }, inventory: [] },
      { id: "player2", name: "Player2", skin: "🐱", health: 92, speed: 5, shield: 0, position: { x: 1200, y: 800 }, inventory: [] },
      { id: "player3", name: "Player3", skin: "🐶", health: 78, speed: 5, shield: 0, position: { x: 900, y: 1100 }, inventory: [] },
    ]
